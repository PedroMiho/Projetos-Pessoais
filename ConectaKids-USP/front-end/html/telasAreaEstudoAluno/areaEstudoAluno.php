...
<head>
  ...
  <title>Painel do Aluno - ConectaKids</title>
...
<body>
  ...
  <main class="py-5">
    <div class="container text-center">
      <h2 class="fw-bold mb-4" style="color: #3e2723;">Painel do Aluno</h2>
      <p class="mb-5" style="color: #5d4037;">Acesse suas atividades, acompanhe seu desempenho e explore recursos educativos de forma prática.</p>
    ...
    <div class="container">
      <div class="row justify-content-between align-items-start text-center">
        ...
        <div class="col-md-4 mb-4">
          ...
          <p class="small">
            Nosso objetivo é conectar alunos e famílias a conteúdos educativos de qualidade, promovendo aprendizado, diversão e inclusão.
          </p>
        </div>
        ...
        <div class="col-md-4 mb-4 d-flex flex-column align-items-center text-center">
          ...
          <ul class="list-unstyled small">
            ...
            <li><a href="html/pacientes.php">Atividades</a></li>
            <li><a href="html/profissionais.php">Professores</a></li>
          </ul>
        </div>
        ...
        <div class="col-md-4 mb-4">
          ...
          <p class="small">Siga-nos para novidades e conteúdos educativos:</p>
